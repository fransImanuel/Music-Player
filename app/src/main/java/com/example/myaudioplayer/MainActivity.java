...
public class MainActivity extends AppCompatActivity {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE){
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED){
                Toast.makeText(this, "Permission Granted! onrequestpermissionresult()", Toast.LENGTH_SHORT).show();
                musicFiles = getAllAudio(this);
                initViewPager();
            }else{
                ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
    ...
    private void initViewPager() {
        ...
        viewPagerAdapter.addFragments(new AlbumFragment(), "Profile");
    ...
    public static  ArrayList<MusicFiles> getAllAudio(Context context){
        ...
        if (cursor!=null){
            while (cursor.moveToNext()){
                ...
                //log e for check
                Log.e("MainActivity", "Album : "+album);
    ...
    protected void onStart() {
        ...
        builder.setMessage("Frans Imanuel\n00000028631");
